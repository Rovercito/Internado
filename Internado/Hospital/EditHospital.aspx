...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
         <h1 style="text-align: center">Modificar Datos del Hospital</h1>
<hr />
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtLatitude"  style="display: none;"      ReadOnly="false"   ClientIDMode="Static" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="form-group">
            <asp:Label ID="lblLongitude" style="display: none;" runat="server" AssociatedControlID="txtLongitude">Longitud</asp:Label>
            <asp:TextBox ID="txtLongitude"  style="display: none;"   ReadOnly="false"   ClientIDMode="Static" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
