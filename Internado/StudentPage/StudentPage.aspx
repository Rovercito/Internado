<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentPage.aspx.cs" Inherits="Internado.StudentPage.StudentPage" %>
                ...
                <div class="container-fluid">
                    ...
                    <div class="justify-content-between">
                       <ul class="navbar-nav flex-grow-1">
                           <li class="nav-item">
                               <a class="nav-link text-white" style="font-size:x-large; text-align: center" href="CompletedTasks.aspx?id=<%= Session["idPerson"].ToString() %>">Tareas<br /> Completadas</a>
                           </li>
                           <li class="nav-item">
