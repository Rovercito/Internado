<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgetPassword.aspx.cs" Inherits="Internado.ForgetPassword" %>
    ...
    <section>
        <div class="login-box" style="background-color:#990040" >
           ...
           <form id="formLogin" runat="server">
               <div class="mb-3">
                    <asp:TextBox runat="server" ID="txtEmail" placeholder="Ingrese Correo" required="" CssClass="form-control" />
                </div> 
               <div class="mb-3">
